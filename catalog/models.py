...
class Language(models.Model):
	# Models representing the language in which the book is written in
	language = models.CharField(max_length=50, help_text="Enter the book's natural language(e.g English, French, Igbo, etc)")
