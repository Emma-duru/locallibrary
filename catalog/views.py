...
from catalog.forms import RenewBookForms
...
def index(request):
	...
	num_books_e = Book.objects.filter(title__icontains="e").count()
...
class LoanedBooksByAllUsersListView(PermissionRequiredMixin, generic.ListView):
	'''Generic class-based view listing books loaned by all users'''
...
def renew_book_librarian(request, pk):
	...
	if request.method == 'POST':
		...
		form = RenewBookForms(request.POST)
		...
		form = RenewBookForms(initial={'renewal_date': proposed_renewal_date})
